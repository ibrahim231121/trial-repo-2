...
import './CRXModalAssetViewReason.scss';
...
const CRXModalAssetViewReason = (props: crxDialogProps) => {
  ...
  return (
    <Dialog
      scroll="paper"
      id={id}
      className={"CRXModalViewReason" + " " + className}
...
export default CRXModalAssetViewReason
