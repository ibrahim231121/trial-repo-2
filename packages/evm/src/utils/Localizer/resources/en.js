export const resources = {
  ...
  en: {
    translation: {
      ...
      "Are_you_sure_you_want_to_delete_all_Assets_from_Bucket": "Are you sure you want to delete all Assets from Bucket?",
      ...
      "You_cannot_assign_more_than_one_user":"You cannot assign more than one user",
      ...
      "Please_retry_or_contact_your_Systems_Administrator": "Please retry or contact your Systems Administrator",
      ...
      "Include_AllGroupedAssets":"Include All Grouped Assets",
      ...
      "You_are_logging_out_from_application":"You are logging out from application. any changes you've made will not be saved.",
      "Are_you_sure_to_logout_your_user_from_application":"Are you sure to logout your user from application ?",
      ...
      "Select_to_show_a_column_Drag_and_drop_to_recorder.": "Select to show a column. Drag and drop to reorder.",
      ...
      "as_the_primary_asset": "as the primary asset",
      "asset_as_the_primary_asset": "asset as the primary asset",
      "You_are_attempting_to": "You are attempting to",
      "set_the": "set the",
      "Are_you_sure_would_like_to" :"Are you sure would like to",
      // -------------------------
      ...
      "Same_As_LoginId":"Same as Login ID",
      ...
      "Please_provide_a_valid_email_as_loginId": "Please provide a valid email as Login ID",
      ...
      "Password_should_be_atleast_eight_characters": "Password should be atleast eight characters long.",
      ...
      "Asset_already_exists_in_the_destination_group_Move_action_cant_be_performed": "Asset already exists in the destination group. Move action cant be performed",
      // ----------------------------
      ...
      "Home": "Home",
      "Cases": "Cases",
      "Tracking_And_Sharing":"Tracking & Sharing",
      ...
      "Success_You_have_saved_the_Sensors_And_Triggers": "Success You have saved the Sensors and Triggers",
      ...
      "Deactivate": "Deactivate",
      "Devices": "DEVICES",
      "Queued_Assets_Caps": "QUEUED ASSETS",
      "Units_&_Devices": "Units & Devices",
      //--------------
      ...
      "Live_Diagnostic":"LIVE DIAGNOSTIC",
      ...
      "Retention_hour_is_required": "Hour is required",
      "Policy_Name_is_required": "Policy Name is required",
      "Retention_size_is_required": "Size is required",
      "Retention_soft_time_is_not_valid": "Retention soft time is not valid",
      "Retention_time_is_not_valid": "Retention time is not valid",
      ...
      "The_title_must_begin_with_the_first_three_characters_as_alphanumeric_and_may_include_'-'_or_'_'_after_that": "The title must begin with the first three characters as alphanumeric and may include '-' or '_' after that",
      "CAD_ID": "CAD ID",
      ...
      "RELATED": "RELATED",
      "REDACTED": "REDACTED",
      "SEE_MORE_ASSETS": "SEE MORE ASSETS",
      "See_More_Assets": "See More Assets",
      "Related_Assets": "Related Assets",
      "Case_Information": "Case Information",
      ...
      "Case_opened_for_evidence": "Case opened for evidence",
      "The_selected_assets_have_been_added_to_Case_{0}": "The selected assets have been added to Case {0}",
      "Update_Share_Options": "Update Share Options",
      ...
      "View_Only._No_Actions_Allowed": "View Only. No Actions Allowed",
      //----------  Case Close  ---------  
	    "Close_Case": "Close Case",
      "Close_Option" : "Close Option",
      "Close_and_Release_Assets(Follows_original_Retention)" : "Close and Release Assets (Follows original Retention)",
      "Close_and_Expire_Assets(Keep_Assets_metadata)" : "Close and Expire Assets (Keep Assets metadata)",
      "Reason" : "Reason",
      "Close_Date" : "Close Date",
      "Immediate " : "Immediate ",
      "Future" : "Future",
      "Request_To_Close_Case" : "Request To Close Case",
      "Case_Close_Saved_Successfully" : "Case Close Saved Successfully",
      "Case_Close_Update_Successfully" : "Case Close Update Successfully",
      "Something_went_wrong" : "Something went wrong",                         
      "You_don't_have_access_to_this_case" : "You don't have access to this case",
      "Closed":"Closed",
      "Approve" : "Approve",
      "Reject" : "Reject",
      // ----------------- version -------------------
      ...
      "Share_selected_items": "Share selected items",
      "Case_{0}_is_open_for_evidence": "Case {0} is open for evidence",
      "Case_{0}_is_close_for_evidence": "Case {0} is close for evidence",
      "Open_case_for_evidence": "Open case for evidence",
      "Close_case_for_evidence": "Close case for evidence",
      "Login_ID" : "Login ID",
      
      // ------ Live Diagnostics ------
      "Diagnostics_Logs": "Logs",
      "System_Info": "System Info",
      "Desktop_Snapshot": "Desktop Snapshot",
      "GPSNMEA_Logs": "GPSNMEA Logs",
      "Sync_Status": "Sync Status",
      "Command_Type_is_required": "Command Type is required",
      "Mode_Type_is_required": "Mode Type is required",
      "Please_enter_a_single_alphabet" : "Please enter a single alphabet",
      "AlgoType" :"AlgoType",
      "Asset_Bookmark" : "Asset Bookmark",
      "User_Id" : "User Id",
      "Yes_export_all_grouped_assets" : "Yes, export all grouped assets",
      "No_only_selected_assets": "No, only selected assets",
      "Export_Assets" : "Export Assets",
      "Would_you_like_to_include_all_grouped_asset_metadata_in_your_export" : "Would you like to include all grouped asset metadata in your export,",
      "Would_you_like_to_include_all_grouped_assets_in_your_export" : "Would you like to include all grouped assets in your export,",
      "along_with_the_primary_that_are_selected" : "along with the primary that are selected?",
      "Export_Asset_Metadata" : "Export Asset Metadata",
      "Yes_all_grouped_asset_metadata" : "Yes, all grouped asset metadata",
      "Are_you_sure_you_would_like_to_delete_category_form": "Are you sure you would like to delete category form?",
      "Are_you_sure_you_would_like_to_delete_form_fields": "Are you sure you would like to delete form fields?",
      "Category_forms": "Category forms",
      "Form_Fields": "Form Fields",
      ...
      "Tracking_deleted":"Tracking & Sharing deleted",
      "Delete_Tracking":"Delete Tracking & Sharing",
      "Edit_Tracking":"Edit Tracking & Sharing", 
      ...
      "Do_you_want_to_revok_share_access_effective_immediately?": "Do you want to revoke share access effective immediately?",
      "Update_Share_Options": "Update Share Options",
      "Revoke_Access": "Revoke Access",
      "Shared_On": "Shared On",
      "Shared_expired._No_actions_allowed": "Shared expired. No actions allowed",
      "Access_to_selected_assets_has_been_revoked": "Access to selected assets has been revoked",
      "Minimum_3_character_and_maximum_15": "Minimum 3 character and maximum 15",
      "Maximum_1024_length_allowed_in_description_field": "Maximum 1024 length allowed in description field",
      "Only_alphabets_digits_and_underscore_are_allowed_Must_start_with_an_alphabet_only" : "Only alphabets, digits and _, - are allowed. Must start with an alphabet only",
//#region ALPR
      //Alpr Capture
      "Plate": "Plate",
      "Hot_List": "Hot List",
