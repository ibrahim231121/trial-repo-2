...
export const AUTHENTICATION_LOGIN_URL = `http://127.0.0.1:8081/Authentication/Login/`

export const AUTHENTICATION_CODEVERIFIER_URL = `http://127.0.0.1:8081/Authentication/CodeVerifier`
