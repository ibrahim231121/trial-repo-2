      ...
      >
        {
          <div className="crxUplockContent">
            You are attempting to <strong>close</strong> the <strong>BC04 Template</strong>. If you close the form, any changes you've made will not be saved. You will not be able to undo this action.
