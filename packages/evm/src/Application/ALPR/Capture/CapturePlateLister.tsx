...
import "./CapturePlateLister.scss"
...
const CapturePlateLister = () => {
    
    const USER_COLID: number = 7;
    const HOTLIST_COLID: number = 4;
    const STATES_COLID: number = 9;
    ...
    return (
        <ClickAwayListener onClickAway={handleBlur}>
            <div className="Alpr_CapturePlateLister_SwitchLeftComponents Alpr_CapturePlateLister_Index" onKeyDown={handleKeyDown}>
...
export default CapturePlateLister;